const Event = ({ isSelected }: IconProps) => {
  const gradientColor = isSelected ? 'url(#paint0_linear_event_selected)' : '#6F6F6F';

  return (
    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="paint0_linear_event_selected" x1="0" y1="0" x2="0" y2="1" gradientUnits="objectBoundingBox">
